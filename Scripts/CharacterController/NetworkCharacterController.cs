...
namespace StarterAssets
{
    ...
    public class NetworkCharacterController : NetworkBehaviour
    {
        ...
        // Anim Sync
        private NetworkVariable<float> animSyncSpeed = new NetworkVariable<float>();
        private NetworkVariable<bool> animSyncIsGrounded = new NetworkVariable<bool>();
        private NetworkVariable<bool> animSyncJump =
            new NetworkVariable<bool>();
        private NetworkVariable<bool> animSyncFreeFall =
            new NetworkVariable<bool>();
        private NetworkVariable<float> animSyncMotionSpeed =
        ...
        {
            Debug.Log($"UpdateJump: {OwnerClientId}");
        ...
        private void UpdateAnims()
        {
            ...
            if (_hasAnimator)
            {
                _animator.SetBool(_animIDJump, animSyncJump.Value);
                _animator.SetBool(_animIDFreeFall, animSyncFreeFall.Value);
                _animator.SetFloat(_animIDSpeed, animSyncSpeed.Value);
                _animator.SetFloat(_animIDMotionSpeed, animSyncMotionSpeed.Value);
                _animator.SetBool(_animIDGrounded, animSyncIsGrounded.Value);
            }
        }
        ...
        private void GroundedCheck()
        {
            ...
            animSyncIsGrounded.Value = Grounded;
        }
        ...
        private void Move()
        {
            ...
            animSyncSpeed.Value = _animationBlend;
            animSyncMotionSpeed.Value = inputMagnitude;
        }
        ...
        private void JumpAndGravity()
        {
            if (Grounded)
            {
                ...
                animSyncJump.Value = false;
                animSyncFreeFall.Value = false;
